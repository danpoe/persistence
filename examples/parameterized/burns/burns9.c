volatile int flag0 = 0, flag1 = 0, flag2 = 0, flag3 = 0, flag4 = 0, flag5 = 0, flag6 = 0, flag7 = 0, flag8 = 0;
...
void * thr0(void * arg)
{
  while (1) {
        flag0 = 0;
  	flag0 = 1;	
        while (flag1 == 1 || flag2 == 1 || flag3 ==1 || flag4 == 1 || flag5 == 1 || flag6 == 1 || flag7 == 1 || flag8 == 1 ) {;}
...
void * thr1(void * arg)
{
  while (1) {
        ...
        if (flag0 != 1) {
  		flag1 = 1;
		if (flag0 != 1) {
			while (flag2 == 1 || flag3 ==1 || flag4 == 1 || flag5 == 1 || flag6 == 1 || flag7 == 1 || flag8 == 1) {;}
			// critical section here
            		flag1 = 0;
		}
        }
...
void * thr2(void * arg)
{
  while (1) {
        ...
        if (flag0 != 1 && flag1 != 1) {
  		flag2 = 1;
		if (flag0 != 1 && flag1 != 1) {
			while (flag3 ==1 || flag4 == 1 || flag5 == 1 || flag6 == 1 || flag7 == 1 || flag8 == 1) {;}
			// critical section here
            		flag2 = 0;
		}
        }
...
void * thr3(void * arg)
{
  while (1) {
        ...
        if (flag0 != 1 && flag1 != 1 && flag2 != 1) {
  		flag3 = 1;
		if (flag0 != 1 && flag1 != 1 && flag2 != 1) {
			while (flag4 == 1 || flag5 == 1 || flag6 == 1 || flag7 == 1 || flag8 == 1) {;}
			// critical section here
            		flag3 = 0;
		}
        }
...
void * thr4(void * arg)
{
  while (1) {
        ...
        if (flag0 != 1 && flag1 != 1 && flag2 != 1 && flag3 !=1 ) {
  		flag4 = 1;
		if (flag0 != 1 && flag1 != 1 && flag2 != 1 && flag3 !=1) {
			while (flag5 == 1 || flag6 == 1 || flag7 == 1 || flag8 == 1) {;}               
			// critical section here
            		flag4 = 0;
		}
        }

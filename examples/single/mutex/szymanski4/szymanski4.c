...
void* thr1(void * arg) {
  while (1) {
    ...
    flag1 = 4;
     while (flag2 == 3 || flag2 == 2 || flag3 == 3 || flag3 == 2 || flag4 == 3 || flag4 == 2) {;}
    flag1 = 0;
  }
}
...
void* thr2(void * arg) {
  while (1) {
    ...
    flag2 = 4;
     while (flag1 >= 2 ) {;}
     while (flag3 == 3 || flag3 == 2 || flag4 == 3 || flag4 == 2 ) {;}
    flag2 = 0;
  }
}
